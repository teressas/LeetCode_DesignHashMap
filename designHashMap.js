...
MyHashMap.prototype.get = function(key) {
    // get key and return key if exists else -1 if it doesn't
...
console.log(obj.get(2));    // return 1, The map is now [[1,1], [2,1]]
obj.remove(2); // remove the mapping for 2, The map is now [[1,1]]
console.log(obj)

console.log(obj.get(2));    // return -1 (i.e., not found), The map is now [[1,1]]